      ...
      <div className="w-full px-2 sm:px-6 lg:px-8">
        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className=" flex-shrink-0 pl-8 ">
            {" "}
            {/* Added padding to the left of the logo */}
          ...
          <div className="hidden sm:flex space-x-4 pr-8">
            {" "}
            {/* Added padding to the right of the menu */}
            <Link
              to="/"
            ...
            <Link
              to="/upload"
              className="inline-flex items-center gap-2 text-black hover:text-red-900 px-3 py-2 rounded-md text-sm font-medium"
            >
